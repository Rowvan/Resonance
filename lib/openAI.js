...
const use_otherwise_2 = "[SECTION 1]Wow, talk about living life musically large! With a staggering total of 412,023 songs under your belt, you've surely experienced more sound waves than an ocean during a storm! And, let’s not forget those 9284920 minutes of pure jam-time bliss. That's pretty much living in a permanent concert, isn't it?Imagine Dragons and Ed Sheeran are the maestros leading your musical symphony, weaving stories through your day. You've got a knack for finding musical gold, and it's clear that your Resonance is strong with themes of hope and introspection. Keep rocking those beats![SECTION 2]Delving into the emotional symphony, let's explore your top song choices. \"I Lived\" by OneRepublic resonates deeply with themes of living life to its fullest—embracing every joy and every broken bone. It's a mantra for fearing less and daring more, embodying a life full of experiences, dreams, and a handful of daring leaps.On the flip side, \"Demons\" by Imagine Dragons taps into the complexities and shadows that often linger beneath the surface. It lets us glimpse the inner battles we all face, those hidden demons and internal rumbles. It's about acknowledging the darker undertones of one's soul while seeking light and redemption.In essence, your musical journey weaves a careful balance—a dance between daring to live boldly and understanding one's inner struggles. Your Resonance shines through an appreciation for authenticity, both in embracing life's highs and anchoring its lows. So, keep the rhythm flowing and let your playlist continue to guide emotional exploration!";
...
export const getTotalRes = async (statsID) => {
    ...
    if (!DO_PING_OPENAI_2) return use_otherwise_2;
